#ifndef LOGMF_EXPERIMENTS_IALS_H
#define LOGMF_EXPERIMENTS_IALS_H
...
public:
    ...
    typedef std::function<const VectorXf(const SpVector &,
                                         const VectorXf &,
                                         const MatrixXf &,
                                         const MatrixXf &,
                                         const float, const float)> ProjectFunction;
    ...
    template<typename F>
    void Step(const SpMatrix &data_by_user, F get_user_embedding_ref, const MatrixXf &item_embedding, const int index_of_item_bias);
...
#endif //LOGMF_EXPERIMENTS_IALS_H
