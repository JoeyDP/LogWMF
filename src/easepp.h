#ifndef LOGMF_EXPERIMENTS_EASEPP_H
#define LOGMF_EXPERIMENTS_EASEPP_H
...
class EASEppRecommender : public Recommender {
public:
    EASEppRecommender(int num_users, int num_items, float reg,
...
#endif //LOGMF_EXPERIMENTS_EASEPP_H
